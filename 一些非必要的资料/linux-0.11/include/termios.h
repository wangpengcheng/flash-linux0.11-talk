...
#define NCC 8
struct termio {
	unsigned short c_iflag;		/* input mode flags */    // 输入模式标志符号
	unsigned short c_oflag;		/* output mode flags */   // 输出模式标志符号
	unsigned short c_cflag;		/* control mode flags */  // 控制模式标志符号
	unsigned short c_lflag;		/* local mode flags */    // 本地模式输出符号
	unsigned char c_line;		/* line discipline */     // 行描述符
	unsigned char c_cc[NCC];	/* control characters */  // 控制字符
};
